 ...
 */
public class CITRebornMixinConfiguration implements IMixinConfigPlugin {
    private static final String MIXINS_ROOT = "com.ponuing.mixin";
    ...
    public void onLoad(String mixinPackage) {
        CITRebornConfig launchConfig = CITRebornConfig.read();
        ...
        if (mixinClassName.startsWith("compat.")) {
            ...
            if (mods.contains(modid)) {
                if (compatMods.add(modid))
                    CITReborn.info("Loading compatibility for " + modid);
