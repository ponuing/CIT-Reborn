 ...
 * Common condition types are available under {@link com.ponuing.cit.builtin.conditions}.
...
public abstract class CITCondition {
     ...
     *
     * @see CITReborn#logWarnLoading(String)
    ...
    protected void warn(String message, PropertyValue value, PropertyGroup properties) {
        CITReborn.logWarnLoading("Warning: " + properties.messageWithDescriptorOf(message, value.position()));
    }
}
