...
import com.ponuing.api.CITDisposable;
import com.ponuing.api.CITTypeContainer;
import com.ponuing.cit.builtin.conditions.core.*;
import com.ponuing.config.CITRebornConfig;
import com.ponuing.pack.GlobalProperties;
import com.ponuing.pack.PackParser;
import com.ponuing.mixin.ModelLoaderMixin;
...
public class ActiveCITs { private ActiveCITs() {}
    ...
    public static void load(ResourceManager resourceManager, Profiler profiler) {
        ...
        if (!CITRebornConfig.INSTANCE.enabled) {
            profiler.pop();
            return;
        }
