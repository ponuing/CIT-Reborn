...
import com.ponuing.cit.builtin.conditions.ConstantCondition;
import com.ponuing.pack.PackParser;
...
import static com.ponuing.CITReborn.logWarnLoading;
...
public final class CITRegistry { private CITRegistry(){}
    ...
    public static void registerAll() {
        ...
        for (var entrypointContainer : FabricLoader.getInstance().getEntrypointContainers(CITConditionContainer.ENTRYPOINT, CITConditionContainer.class)) {
            ...
            if (namespace.equals("pcit") || namespace.equals("citresewn-defaults") || namespace.equals("citreborn") || namespace.equals("citreborn-defaults"))
                namespace = "citresewn";
