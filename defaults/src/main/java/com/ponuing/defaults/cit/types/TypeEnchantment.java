...
import com.ponuing.defaults.cit.conditions.ConditionEnchantments;
import com.ponuing.defaults.config.CITRebornDefaultsConfig;
import com.ponuing.defaults.mixin.types.enchantment.RenderPhaseAccessor;
...
import com.ponuing.util.logic.Loops;
...
public class TypeEnchantment extends CITType {
    ...
    public static class Container extends CITTypeContainer<TypeEnchantment> implements CITGlobalProperties {
        ...
        public void load(List<CIT<TypeEnchantment>> parsedCITs) {
            ...
            for (CIT<TypeEnchantment> cit : loaded)
                for (GlintRenderLayer glintLayer : GlintRenderLayer.values()) {
                    ...
                    MinecraftClient.getInstance().getBufferBuilders().getEntityVertexConsumers().layerBuffers.put(renderLayer, new BufferAllocator(renderLayer.getExpectedBufferSize()));
                }
        }
        ...
        public Container setContext(CITContext context) {
            ...
            List<WeakReference<CIT<TypeEnchantment>>> cits = ((CITCacheEnchantment) (Object) context.stack).CITReborn$getCacheTypeEnchantment().get(context);
    ...
    public enum GlintRenderLayer {
        ...
        public RenderLayer build(TypeEnchantment enchantment, Identifier propertiesIdentifier) {
            class Texturing implements Runnable {
                ...
                @Override
                public void run() {
                    float l = Util.getMeasuringTimeMs() * CITRebornDefaultsConfig.INSTANCE.type_enchantment_scroll_multiplier * speed;
            ...
            RenderLayer.MultiPhaseParameters.Builder layer = RenderLayer.MultiPhaseParameters.builder()
                    .texture(new RenderPhase.Texture(enchantment.texture, enchantment.blur ? TriState.TRUE : TriState.FALSE, false))
                    .texturing(new RenderPhase.Texturing("CITReborn_glint_texturing", new Texturing(enchantment.speed, enchantment.rotation, enchantment.r, enchantment.g, enchantment.b, enchantment.a, enchantment.methodIntensity), () -> {
    ...
    public interface CITCacheEnchantment {
        CITCache.MultiList<TypeEnchantment> CITReborn$getCacheTypeEnchantment();
    }
}
